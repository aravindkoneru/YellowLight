...
public class SituationTester {
	...
	public static void main(String[] args){
		...
		System.out.format("%-20s%-20s%-20s%-30s%-20s%-30s%-20s%-20s%-20s%-20s", "Velocity", "Acceleration", "Stopping Distance", "Distance From Light", "Stopping Time", "Distance Before Braking", "Light Time", "Stop in Time", "Stop in Distance", "Can Pass?");
		//System.out.println("\n");
